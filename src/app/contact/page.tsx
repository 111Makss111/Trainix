...
export default function ContactPage() {
  return (
    <LegalPage
      ...
      intro="Якщо ти хочеш отримати ранній доступ, поділитися ідеєю, написати про баг або обговорити розвиток продукту, тут зібрані основні канали зв'язку, а на етапі ранньої beta це найшвидший спосіб напряму достукатися до Trainix"
