...
const reasonLabels: Record<string, string> = {
  ...
  amount:
    "Сума підтримки вказана некоректно, спробуй ввести ціле число в доларах від $1",
...
export default async function SupportUnavailablePage({
  ...
  return (
    <SupportShell
      ...
      description={`${reason}, а якщо проблема повторюється, можна повернутися на головну, а також написати напряму на support.trainix@gmail.com`}
